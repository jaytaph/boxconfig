...
class SoftwareCategoryType extends AbstractType
{
    ...
    function __construct(\BoxConfig\DefaultBundle\Entity\SoftwareCategory $category)
    {
    ...
    public function buildForm(FormBuilder $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('parent', 'entity', array(
                ...
                'class' => 'BoxConfig\DefaultBundle\Entity\SoftwareCategory',
    ...
    {
        return 'boxconfig_defaultbundle_softwarecategorytype';
    }
}
