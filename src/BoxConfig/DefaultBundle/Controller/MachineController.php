...
use BoxConfig\DefaultBundle\Entity\Machine;
use BoxConfig\DefaultBundle\Form\MachineType;
...
class MachineController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BoxConfigDefaultBundle:Machine')->findAll();

        return $this->render('BoxConfigDefaultBundle:Machine:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BoxConfigDefaultBundle:Machine')->find($id);
        ...
        return $this->render('BoxConfigDefaultBundle:Machine:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('BoxConfigDefaultBundle:Machine:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BoxConfigDefaultBundle:Machine:edit.html.twig', array(
            'entity'      => $entity,
