...
use BoxConfig\DefaultBundle\Form\SoftwareType;
...
class SoftwareController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BoxConfigDefaultBundle:Software')->findAll();

        return $this->render('BoxConfigDefaultBundle:Software:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BoxConfigDefaultBundle:Software')->find($id);
        ...
        return $this->render('BoxConfigDefaultBundle:Software:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('BoxConfigDefaultBundle:Software:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BoxConfigDefaultBundle:Software:edit.html.twig', array(
            'entity'      => $entity,
