...
use BoxConfig\DefaultBundle\Entity\Configuration;
use BoxConfig\DefaultBundle\Form\ConfigurationType;
...
class ConfigurationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BoxConfigDefaultBundle:Configuration')->findAll();

        return $this->render('BoxConfigDefaultBundle:Configuration:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BoxConfigDefaultBundle:Configuration')->find($id);
        ...
        return $this->render('BoxConfigDefaultBundle:Configuration:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('BoxConfigDefaultBundle:Configuration:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BoxConfigDefaultBundle:Configuration:edit.html.twig', array(
            'entity'      => $entity,
