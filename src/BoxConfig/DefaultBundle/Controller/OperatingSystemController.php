...
use BoxConfig\DefaultBundle\Form\OperatingSystemType;
...
class OperatingSystemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BoxConfigDefaultBundle:OperatingSystem')->findAll();

        return $this->render('BoxConfigDefaultBundle:OperatingSystem:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BoxConfigDefaultBundle:OperatingSystem')->find($id);
        ...
        return $this->render('BoxConfigDefaultBundle:OperatingSystem:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('BoxConfigDefaultBundle:OperatingSystem:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BoxConfigDefaultBundle:OperatingSystem:edit.html.twig', array(
            'entity'      => $entity,
