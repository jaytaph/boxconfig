...
use BoxConfig\DefaultBundle\Entity\SoftwareCategory;
use BoxConfig\DefaultBundle\Form\SoftwareCategoryType;
...
class SoftwareCategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BoxConfigDefaultBundle:SoftwareCategory')->findAll();

        return $this->render('BoxConfigDefaultBundle:SoftwareCategory:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BoxConfigDefaultBundle:SoftwareCategory')->find($id);
        ...
        return $this->render('BoxConfigDefaultBundle:SoftwareCategory:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('BoxConfigDefaultBundle:SoftwareCategory:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BoxConfigDefaultBundle:SoftwareCategory:edit.html.twig', array(
            'entity'      => $entity,
