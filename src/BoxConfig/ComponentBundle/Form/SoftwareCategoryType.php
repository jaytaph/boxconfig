...
class SoftwareCategoryType extends AbstractType
{
    ...
    function __construct(\BoxConfig\ComponentBundle\Entity\SoftwareCategory $category)
    {
    ...
    public function buildForm(FormBuilder $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('parent', 'entity', array(
                ...
                'class' => 'BoxConfig\ComponentBundle\Entity\SoftwareCategory',
    ...
    {
        return 'boxconfig_ComponentBundle_softwarecategorytype';
    }
}
